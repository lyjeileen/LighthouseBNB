...
const getUserWithId = function (id) {
  return pool
    ...
    .then((result) => {
      console.log("refesh object: ", result.rows[0]);
      return result.rows[0];
    })
    .catch((err) => {
      return null;
...
const addUser = function (user) {
  ...
  return pool
    ...
    .then((result) => {
      console.log("addUser object: ", result.rows[0]);
      return result.rows[0];
    })
    .catch((err) => {
      return null;
 ...
 */
const getAllProperties = (options, id, limit = 10) => {
  const queryParams = [];
  ...
  console.log("string", queryString, "params array", queryParams);
...
const addProperty = function (property) {
  ...
  return pool
    ...
    .then((result) => {
      console.log("addproperty object: ", result.rows[0]);
      return result.rows[0];
    })
    .catch((err) => {
      return null;
